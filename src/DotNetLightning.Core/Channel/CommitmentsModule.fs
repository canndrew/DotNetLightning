...
module internal Commitments =
    module private Helpers =
        ...
        let makeRemoteTxs
            ...
            let remotePaymentPK = remotePerCommitmentPoint.DerivePaymentPubKey remoteChannelKeys.PaymentBasepoint
        ...
        let makeLocalTXs
            ...
            let localPaymentPK = localPerCommitmentPoint.DerivePaymentPubKey localChannelKeys.PaymentBasepoint
