...
module ChannelConstants =
    ...
    let BREAKDOWN_TIMEOUT = BlockHeightOffset16.FromBlocks(6us * 24us * 7us) // one week
    let MAX_LOCAL_BREAKDOWN_TIMEOUT = BlockHeightOffset16.FromBlocks(6us * 24us * 14us) // two weeks

    /// Specified in BOLT 11
    let MIN_CLTV_EXPIRY = 9us |> BlockHeightOffset16.FromBlocks
