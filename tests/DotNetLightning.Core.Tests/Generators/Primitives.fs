...
let blockHeightOffset16Gen = Arb.generate<uint16> |> Gen.map BlockHeightOffset16.FromBlocks
let blockHeightOffset32Gen = Arb.generate<uint32> |> Gen.map BlockHeightOffset32.FromBlocks
